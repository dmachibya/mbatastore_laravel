...
class PaymentMethod extends BaseModel
{
    ...
    public function typeName($type)
    {
        switch ($type) {
            ...
            case static::DIGITAL_WALLET:
                return trans('app.payment_method_type.digital_wallet.name');

            case static::MOBILE_WALLET:
                return trans('app.payment_method_type.mobile_wallet.name');
