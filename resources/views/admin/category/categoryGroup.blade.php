        ...
        <tbody id="massSelectArea">
          @foreach ($categoryGrps as $categoryGrp)
            <tr>
              ...
              @endcan
              <td>
                @if (!is_null(optional($categoryGrp->backgroundImage)->path) && Storage::exists(optional($categoryGrp->backgroundImage)->path))
                  <img src="{{ get_storage_file_url(optional($categoryGrp->backgroundImage)->path, 'small') }}" class="" alt="{{ trans('app.background_image') }}">
                @endif
              </td>
              <td>
                @if (!is_null(optional($categoryGrp->coverImage)->path) && Storage::exists(optional($categoryGrp->coverImage)->path))
