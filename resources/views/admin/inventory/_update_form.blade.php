<div class="modal-dialog modal-md">
    <div class="modal-content">
      {!! Form::open(['route' => 'admin.stock.inventory.bulkUpdate', 'files' => true, 'id' => 'form', 'data-toggle' => 'validator']) !!}
      ...
      <div class="modal-body">
        <ul>
          ...
          <li>{{ trans('help.inventory_has_to_exist') }}</li>
          <li>{!! trans('help.download_template', ['url' => route('admin.stock.inventory.bulkUpdate.downloadTemplate')]) !!}</li>
          <li>{!! trans('help.first_row_as_header') !!}</li>
          <li>{!! trans('help.required_fields_csv', ['fields' => implode(',', config('system.import_required.inventory_update', []))]) !!}</li>
