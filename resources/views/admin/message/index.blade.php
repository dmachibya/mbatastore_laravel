                    ...
                    <tr id="item_{{ $message->id }}">
                      ...
                      <td class="mailbox-subject">
                        <a href="{{ route('admin.support.message.show', $message) }}" style="{{ $message->isUnread() ? 'color: #222;' : '' }}">
                          <strong>{!! highlightWords($message->subject, $search_q) !!} </strong> - {!! highlightWords(Str::limit(strip_tags($message->lastReply->reply ?? $message->message), 160 - strlen($message->subject)), $search_q) !!}
                        </a>
                      </td>
